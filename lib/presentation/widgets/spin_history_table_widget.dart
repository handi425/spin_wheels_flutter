...
class SpinHistoryTableWidget extends StatelessWidget {
                  ...
                  child: Row(
                    ...
                    children: [
                      _statisticsCard(
                        context: context,
                        icon: Icons.casino,
                        value: spinHistoryProvider.statistics['totalCount']?.toString() ?? '0',
                        label: 'Total Spin',
                      ...
                      _statisticsCard(
                        ...
                        value: spinHistoryProvider.statistics['sentCount']?.toString() ?? '0',
                        label: 'Terkirim',
                        color: Colors.green,
                      ),
                      _statisticsCard(
                        context: context,
                        icon: Icons.schedule,
                        value: spinHistoryProvider.statistics['unsentCount']?.toString() ?? '0',
              ...
              child: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: spinHistoryProvider.spinHistories.map((history) {
                      final userName = history.userData != null ? history.userData!['name'] : 'Unknown';
                      final prizeName = history.prizeData != null ? history.prizeData!['name'] : 'Unknown';
                      
                      return DataRow(
                        cells: [
                          DataCell(
                            Text(Utils.formatDate(history.createdAt, format: 'dd/MM/yyyy HH:mm')),
                          ),
                          DataCell(
                            Text(userName),
                          ),
                          ...
                          DataCell(
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: history.isSent ? Colors.green : Colors.orange,
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                history.isSent ? 'Terkirim' : 'Belum Terkirim',
                              ...
                              children: [
                                if (!history.isSent)
                                  IconButton(
                                    ...
                                    onPressed: () => _markAsSent(context, history),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Apakah Anda yakin ingin menandai hadiah ini sebagai terkirim?',
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              spinHistoryProvider.markAsSent(
                history.id!,
                ...
                if (success) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Hadiah berhasil ditandai terkirim'),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(spinHistoryProvider.error ?? 'Gagal menandai hadiah terkirim'),
  ...
  void _showDetailDialog(BuildContext context, SpinHistory history) {
    final userName = history.userData != null ? history.userData!['name'] : 'Unknown';
    final userEmail = history.userData != null ? history.userData!['email'] : null;
    final prizeName = history.prizeData != null ? history.prizeData!['name'] : 'Unknown';
    final prizeValue = history.prizeData != null ? history.prizeData!['value'] : null;
        ...
        content: Column(
          ...
          children: [
            _detailItem(
              ...
              icon: Icons.event,
              label: 'Tanggal Spin',
              value: Utils.formatDate(history.createdAt, format: 'dd MMMM yyyy, HH:mm'),
            ),
            ...
            if (history.isSent && history.sentAt != null) ...[
              ...
              _detailItem(
                ...
                icon: Icons.send,
                label: 'Tanggal Kirim',
                value: Utils.formatDate(history.sentAt!, format: 'dd MMMM yyyy, HH:mm'),
              ),
            ],
